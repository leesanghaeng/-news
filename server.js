  ...
  if (pathname === '/') {
    ...
    <hr>
      ...
      <form action="/post_test" method="post">
        <div class="content-div">호수<input type="text" name="ho" id="ho1" placeholder="1100"></div>
        <div class="content-div">날짜<input type="text" name="date" id="ekasb_date" placeholder="2023년 9월 16일"></div>
        <div class="content-div" id = "noticeT1"><input type="text" name="notice1n" id="notice1n"  value ="1." style="width: 10px;">공지1 제목<input type="text" name="notice1" placeholder="title" id = "notice1_title" value =""> URL <input type="text" name="notice1_url" placeholder="title" id = "notice1_url" value =""></div>
        <div class="content-div" id = "noticeT2"><input type="text" name="notice2n" id="notice2n"  value ="2." style="width: 10px;">공지2 제목<input type="text" name="notice2" placeholder="title" id = "notice2_title" value =""> URL <input type="text" name="notice2_url" placeholder="title" id = "notice2_url" value =""></div>
        <div class="content-div" id = "noticeT3"><input type="text" name="notice3n" id="notice3n"  value ="3." style="width: 10px;">공지3 제목<input type="text" name="notice3" placeholder="title" id = "notice3_title" value =""> URL <input type="text" name="notice3_url" placeholder="title" id = "notice3_url" value =""></div>
        <div class="content-div" id = "noticeT4"><input type="text" name="notice4n" id="notice4n"  value ="4." style="width: 10px;">공지4 제목<input type="text" name="notice4" placeholder="title" id = "notice4_title" value =""> URL <input type="text" name="notice4_url" placeholder="title" id = "notice4_url" value =""></div>
...
function jsonfunc5( jsonText5 ) {
    ...
    request.on('end', function () {
     ...
     ho = post.ho;
	  ...
	  var notice1n = post.notice1n
      var notice2n = post.notice2n
      var notice3n = post.notice3n
	  var notice4n = post.notice4n
																			...
																			<tr>
																				<td valign="top">
																					<table width="325" cellspacing="0" cellpadding="0">
																						<tbody>
																							<tr>
																								<td width="15" valign="top" style="font-size:12px; color:#555; line-height:18px; padding:2px 0px 15px 0px; font-family:'나눔고딕',NanumGothic,Sans-serif;">${notice1n}</td>
