  ...
  if (pathname === '/') {
    ...
    <hr>
      ...
      <form action="/post_test" method="post">
        ...
        <p>공개 초안 및 의견조회 3<input type="text" name="open3" id="open3"placeholder="title" value =""> URL <input type="text" name="open3_url"  id="open3_url"placeholder="title"> 기한 <input type="text" name="open3_dr"  id="open3_dr" placeholder="(기한: 2023.09.15.)"></p>
...
xhttp4.open("GET","http://news.kasb.store:8085/ekasb", true);
...
xhttp5.open("GET","http://news.kasb.store:8085/opinion", true);
